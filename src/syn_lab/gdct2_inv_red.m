function x = gdct2_inv_red(C, N1, N2, is_real, R_high,R_low, rad, is_cos, t_sc, s_sc, red, wedge_length_coarse)
% gdct2_inv_red.m - 2D Inverse Generalized Discrete Curvelet Transform for
% gdct_fwd_red.m
%
% Inputs
...
if nargin < 11, red = 1; end;
if nargin < 12, wedge_length_coarse = 8; end;
...
if R_low == 0
        ...
        for cnt2 = 1:nbangles(cnt)
            for cnt3 = 0:red-1
                if cnt2 < nbangles(cnt)
                    ...
                    tiling{cnt-1}{1,cnt2,cnt3+1} = struct('polar_a',0,'index_1',0,'index_2',0,'X_val',0,'lowpass',0,'hipass',0);
                    ...
                    tiling{cnt-1}{2,cnt2,cnt3+1} = struct('polar_a',0,'index_1',0,'index_2',0,'X_val',0,'lowpass',0,'hipass',0);
    ...
    XX(level{1}.index_1+pN1+1+(level{1}.index_2+pN2+1-1)*N1) = temp(x1+(x2-1)*sz(1))*red;
    x1 = mod(level{2}.index_1,sz(1))+1;
    x2 = mod(level{2}.index_2,sz(2))+1;
    XX(level{2}.index_1+pN1+1+(level{2}.index_2+pN2+1-1)*N1) = temp(x1+(x2-1)*sz(1)).*(level{2}.lowpass)*red;
    for cnt =3:nbscales
        %fac = sqrt(sz(1)*sz(2));% sqrt(angles(cnt)*(wedge_end(cnt)^2-wedge_end(cnt-2)^2)/4);
        for cnt2 = 1:nbangles(cnt)
            for cnt3 = 0:red-1
                temp = fftshift(fft2(ifftshift(C{cnt-1}{cnt2,cnt3+1})))/(sqrt(sz(1)*sz(2)));
                x1 = mod(tiling{cnt-1}{1,cnt2,cnt3+1}.index_1+pN1+1,sz(1))+1;
                x2 = mod(tiling{cnt-1}{1,cnt2,cnt3+1}.index_2+pN2+1,sz(2))+1;
                tiling{cnt-1}{1,cnt2,cnt3+1}.X_val = tiling{cnt-1}{1,cnt2,cnt3+1}.X_val + temp(x1+(x2-1)*sz(1)).*(tiling{cnt-1}{1,cnt2,cnt3+1}.lowpass);
                x1 = mod(tiling{cnt-1}{2,cnt2,cnt3+1}.index_1+pN1+1,sz(1))+1;
                x2 = mod(tiling{cnt-1}{2,cnt2,cnt3+1}.index_2+pN2+1,sz(2))+1;
                tiling{cnt-1}{2,cnt2,cnt3+1}.X_val = tiling{cnt-1}{2,cnt2,cnt3+1}.X_val + temp(x1+(x2-1)*sz(1)).*(tiling{cnt-1}{2,cnt2,cnt3+1}.lowpass);
                if cnt2 < nbangles(cnt)
                    x1 = mod(tiling{cnt-1}{1,cnt2+1,cnt3+1}.index_1+pN1+1,sz(1))+1;
                    x2 = mod(tiling{cnt-1}{1,cnt2+1,cnt3+1}.index_2+pN2+1,sz(2))+1;
                    tiling{cnt-1}{1,cnt2+1,cnt3+1}.X_val = tiling{cnt-1}{1,cnt2+1,cnt3+1}.X_val+ temp(x1+(x2-1)*sz(1)).*(tiling{cnt-1}{1,cnt2+1,cnt3+1}.hipass);
                    x1 = mod(tiling{cnt-1}{2,cnt2+1,cnt3+1}.index_1+pN1+1,sz(1))+1;
                    x2 = mod(tiling{cnt-1}{2,cnt2+1,cnt3+1}.index_2+pN2+1,sz(2))+1;
                    tiling{cnt-1}{2,cnt2+1,cnt3+1}.X_val = tiling{cnt-1}{2,cnt2+1,cnt3+1}.X_val + temp(x1+(x2-1)*sz(1)).*(tiling{cnt-1}{2,cnt2+1,cnt3+1}.hipass);
                else
                    x1 = mod(tiling{cnt-1}{1,1,cnt3+1}.index_1+pN1+1,sz(1))+1;
                    x2 = mod(tiling{cnt-1}{1,1,cnt3+1}.index_2+pN2+1,sz(2))+1;
                    tiling{cnt-1}{1,1,cnt3+1}.X_val = tiling{cnt-1}{1,1,cnt3+1}.X_val+ temp(x1+(x2-1)*sz(1)).*(tiling{cnt-1}{1,1,cnt3+1}.hipass);
                    x1 = mod(tiling{cnt-1}{2,1,cnt3+1}.index_1+pN1+1,sz(1))+1;
                    x2 = mod(tiling{cnt-1}{2,1,cnt3+1}.index_2+pN2+1,sz(2))+1;
                    tiling{cnt-1}{2,1,cnt3+1}.X_val = tiling{cnt-1}{2,1,cnt3+1}.X_val + temp(x1+(x2-1)*sz(1)).*(tiling{cnt-1}{2,1,cnt3+1}.hipass);
                end
            end
        end
    end
    for cnt = 3:nbscales
        for cnt2 = 1:nbangles(cnt)
            for cnt3 = 0:red-1
                if cnt2 < nbangles(cnt)
                    pos = find(level{cnt}.polar_a>=(cnt2-1+cnt3/red)*angles(cnt) & level{cnt}.polar_a<(cnt2+cnt3/red)*angles(cnt));
                    level{cnt}.X_val(pos) = level{cnt}.X_val(pos) + tiling{cnt-1}{1,cnt2,cnt3+1}.X_val;
                    pos = find(level{cnt-1}.polar_a>=(cnt2-1+cnt3/red)*angles(cnt) & level{cnt-1}.polar_a<(cnt2+cnt3/red)*angles(cnt));
                    level{cnt-1}.X_val(pos) = level{cnt-1}.X_val(pos) + tiling{cnt-1}{2,cnt2,cnt3+1}.X_val;
                else
                    pos = find(level{cnt}.polar_a>=(cnt2-1+cnt3/red)*angles(cnt) | level{cnt}.polar_a < (cnt2+cnt3/red)*angles(cnt)-2*pi);
                    level{cnt}.X_val(pos) = level{cnt}.X_val(pos) + tiling{cnt-1}{1,cnt2,cnt3+1}.X_val;
                    pos = find(level{cnt-1}.polar_a>=(cnt2-1+cnt3/red)*angles(cnt) | level{cnt-1}.polar_a<(cnt2+cnt3/red)*angles(cnt)-2*pi);
    ...
    for cnt = 3:nbscales
        ...
        for cnt2 = 1:nbangles(cnt)
            for cnt3 = 0:red-1
                if cnt2 < nbangles(cnt)
                    pos = find(level{cnt}.polar_a>=(cnt2-1+cnt3/red)*angles(cnt) & level{cnt}.polar_a < (cnt2+cnt3/red)*angles(cnt));
                    tiling{cnt-1}{1,cnt2,cnt3+1} = struct('polar_a',0,'index_1',0,'index_2',0,'X2_val',0,'lowpass',0,'hipass',0);
                    tiling{cnt-1}{1,cnt2,cnt3+1}.polar_a = level{cnt}.polar_a(pos);
                    tiling{cnt-1}{1,cnt2,cnt3+1}.index_1 = level{cnt}.index_1(pos);
                    tiling{cnt-1}{1,cnt2,cnt3+1}.index_2 = level{cnt}.index_2(pos);
                    tiling{cnt-1}{1,cnt2,cnt3+1}.X_val = level{cnt}.X_val(pos);
